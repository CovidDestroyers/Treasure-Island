...
public class TreasureIslandGameplay {
  ...
  public void customGameplayOptions() throws InterruptedException {
    System.out.println(
        "Would you like to Load existing game, play the full game, or play on a sample island? L/F/S");
  ...
  public void storylineProgression(String fileName, String location, String start, String stop) {
    try {
      File myObj =
          new File( "./TreasureIsland/src/com/treasureisland/text/"
                  + fileName);
      ...
      while (myReader.hasNextLine()) {
        ...
        if (data.equals(stop)) { // tag to end reading the file.
          tokenFound = false;
        }
